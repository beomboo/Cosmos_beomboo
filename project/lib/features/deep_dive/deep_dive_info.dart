...
/// **2026-07-19 변경(목업 STEP 5 리팩터, `/grill-me` 합의)**: 결과 화면(STEP 4)의
/// 카테고리 카드가 빠지면서 그 4개(연애·재물·건강·성격)가 관심사 선택으로 그대로
/// 옮겨왔다 — 그동안 "항상 기본 노출"이라 선택지에서 뺐던 [personality]도 이제
/// 다른 관심사와 동등하게 선택 대상이다.
enum Interest {
  love('연애운', '💘'),
  career('직장운', '💼'),
  wealth('재물운', '💰'),
